...
#        from          to     value
#1 subgroup_65 subgroup_34 0.6611016
#2 subgroup_36 subgroup_25 0.5782294
#3 subgroup_11 subgroup_19 0.9832864
#4 subgroup_10 subgroup_23 0.2811993
#5 subgroup_19 subgroup_36 0.6643508
#6 subgroup_23 subgroup_44 0.2095893
...
png("figure2.png", height = 480, width=480)
...
ggraph(mygraph, layout = 'dendrogram', circular = TRUE) + 
  ...
  #ref:https://www.r-graph-gallery.com/hierarchical-edge-bundling/
